        ...
        if (current === "NO_MATCHES") {
          return (
            <>
              ...
              <p>Try another search, or show all destinations and kinds.</p>
        ...
        if (current === "PAUSED") {
          return (
            <>
              ...
              <p>
                Your application keeps reporting. Resume to capture new events.
              </p>
            </>
          );
        }
        ...
        if (current === "WAITING") {
          return (
            <>
              ...
              <p>
                Reports, destination outcomes and session changes appear here as
                your application runs. None of them carries report content.
              </p>
            </>
          );
        }
