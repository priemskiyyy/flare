  ...
  return (
    <details class="event" data-kind={props.event.kind}>
      <summary>
        ...
        <span class="event-destination">
          {props.event.destination ?? props.event.source}
        </span>
        <span class="event-report" title={props.event.report ?? undefined}>
          {formatReportId(props.event.report)}
        </span>
